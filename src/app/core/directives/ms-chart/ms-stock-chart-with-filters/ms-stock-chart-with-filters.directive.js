(function ()
{
    ...
    angular
        .module('app.core')
        .controller('msStockChartWithFilterController', msStockChartWithFilterController)
        .directive('msStockChartWithFilter', msStockChartDirective);

    function msStockChartWithFilterController($mdSidenav, stockService, $rootScope, dialog) {
        var vm = this;

        vm.fetchChartData = fetchChartData;
        vm.fetchChartDataFromServer = fetchChartDataFromServer;
        vm.onPeerRemove = onPeerRemove;
        ...
        function fetchChartData(stockString, selectedPeriod, splits, earnings, dividends, start_date, end_date) {
        ...
        function fetchChartDataFromServer() {
    ...
    function msStockChartDirective()
    {
        return {
            restrict: 'E',
            replace:true,
            templateUrl: 'app/core/directives/ms-chart/ms-stock-chart-with-filters/ms-stock-chart-with-filters.html',
            scope : {
               'chartFilterState' : '=',
                'hideFilters' : '='
            },
            controller : 'msStockChartWithFilterController',
            controllerAs : 'vm',
